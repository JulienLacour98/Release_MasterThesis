...
### -- specify that we want the job to get killed if it exceeds 100MBB per core/slot --
#BSUB -M 100MB
...
#BSUB -o Script_3-5-9_%J.csv
#BSUB -e Error_3-5-9_%J.err
...
python3 Main.py 3 1 9 5 20 60 5 100 20