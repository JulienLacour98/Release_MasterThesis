...
### -- specify that we want the job to get killed if it exceeds 100MB per core/slot --
#BSUB -M 100MB
...
#BSUB -o Script_3-4-8_%J.csv
#BSUB -e Error_3-4-8_%J.err
...
python3 Main.py 3 1 7 2 40 160 20 200 20